...
const tailwindConfig = {
  ...
  theme: {
    extend: {
      animation: {
        ripple: 'ripple 700ms forwards',
        'text-animation': 'text-animation 2.4s ease-in-out alternate infinite',
      },
      backgroundImage: {
        about: `url(${getCFDBaseURL('assets/images/about.png')})`,
        portfolio: `url(${getCFDBaseURL('assets/images/portfolio.png')})`,
        services: `url(${getCFDBaseURL('assets/images/services.png')})`,
        contact: `url(${getCFDBaseURL('assets/images/contact.png')})`,
      },
      fontFamily: {
        'amsterdam-four': ['Amsterdam Four', 'system-ui'],
